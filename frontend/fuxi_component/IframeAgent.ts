...
export class IframeAgent {
  ...
  private initContainer() {
    ...
    this.toggleBtn.innerHTML = this.options.robotIconUrl
      ? `<img url="${this.options.robotIconUrl}" style="width: ${this.options.imgWidth}, height: ${this.options.imgHeight}"/>`

      : `
      <svg xmlns="http://www.w3.org/2000/svg" width="${this.options.imgWidth}" height="${this.options.imgHeight}" fill="currentColor" viewBox="0 0 16 16">
